        ...
        <div className='container'>
            ...
            <div className='row mb-5 text-muted' style={{lineHeight:"1.8 "}}>
                ...
                <div className='col-5 p-5'>
                    <p>Nithin bootstrapped and founded Finora in 2010 to overcome the hurdles he faced during his decade long stint as a trader. Today, Finora has changed the landscape of the Indian broking industry.</p>
