    ...
    return (
        <div className='container'>
          <div className='row m-5'>
            <h2 className='mt-5 mb-3'>To create a ticket, select a relevent topic.</h2>
          <div className='col-4 ' style={{lineHeight:"2.5"}}>
            <h4 className='mt-5 mb-4'><i class="fa-solid fa-circle-plus fa-xs fs-6" style={{marginRight:"5px"}}></i>Account Opening</h4>
           ...
           <div className='col-4 mb-5 ' style={{lineHeight:"2.5"}}>
            ...
            <a href='' style={{textDecoration:"none"}}>GTT</a><br/>
          </div>  

           <div className='col-4 ' style={{lineHeight:"2.5"}}>
            <h4 className='mt-5 mb-4'><i class="fa-regular fa-credit-card fa-xs fs-6" style={{marginRight:"5px"}}></i> Fund</h4>
           ...
           <div className='col-4 ' style={{lineHeight:"2.5"}}>
            <h4 className='mt-5 mb-4'><i class="fa-solid fa-circle-notch fa-xs fs-6" style={{marginRight:"5px"}}></i> Console</h4>
           ...
           <div className='col-4 mb-5' style={{lineHeight:"2.5"}}>
            <h4 className='mt-5 mb-4'><i class="fa-regular fa-circle fa-xs fs-6" style={{marginRight:"5px"}}></i> Coin </h4>
